    ...
    public class SQLServerContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Prontuario>()
                .HasData(
                new {Id = 1, PacienteId = 1, MedicoId = 1, QueixaPrincipal = "Dor na barriga", Descricao = "Aproximadamente há 20 dias, evoluiu uma dor forte na barriga que piora com café e bebidas ácidas", HistoricoFamiliar = "Ninguém na família com sistomas parecidos", ExameFisico = "BNF sem SA, MVUA sem alterações, dor a palpação de região epigástrica", Conduta = "Solicito EDA, PHmetria e exames laboratoriais ", HipoteseDiagnostica = "K29 - Gastrite e duodenite", Prescricao = "Annita de 12/12hs por 3 dias", CreatedOn = DateTime.Now},
                new { Id = 2, PacienteId = 1, MedicoId = 1, QueixaPrincipal = "Dor de cabeça", Descricao = "Aproximadamente há 20 dias, evoluiu uma dor forte na cabeça", HistoricoFamiliar = "Ninguém na família com sistomas parecidos", ExameFisico = "BNF sem SA, MVUA sem alterações, dor a palpação de região epigástrica", Conduta = "Solicito EDA, PHmetria e exames laboratoriais ", HipoteseDiagnostica = "Dor de cabeça normal", Prescricao = "Dipirona de 12/12hs por 3 dias", CreatedOn = DateTime.Now }
                );
        }
