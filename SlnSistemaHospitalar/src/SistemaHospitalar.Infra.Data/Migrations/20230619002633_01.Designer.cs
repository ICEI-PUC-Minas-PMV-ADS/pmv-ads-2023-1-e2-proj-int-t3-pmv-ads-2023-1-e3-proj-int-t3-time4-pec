            ...
            modelBuilder.Entity("SistemaHospitalar.Domain.Entities.Pessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "156.789.754-85",
                            CreatedOn = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7363),
                            DataNascimento = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7354),
                            Email = "ana@gmail.com",
                        ...
                        new
                        {
                            Id = 2,
                            Cpf = "456.799.466-65",
                            CreatedOn = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7365),
                            DataNascimento = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7364),
                        ...
                        new
                        {
                            Id = 3,
                            Cpf = "787.464.796-56",
                            CreatedOn = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7367),
                            DataNascimento = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7366),
                        ...
                        new
                        {
                            Id = 4,
                            Cpf = "899.799.465-78",
                            CreatedOn = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7368),
                            DataNascimento = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7368),
            ...
            modelBuilder.Entity("SistemaHospitalar.Domain.Entities.Prontuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7442),
                        ...
                        new
                        {
                            Id = 2,
                            Conduta = "Solicito EDA, PHmetria e exames laboratoriais ",
                            CreatedOn = new DateTime(2023, 6, 18, 21, 26, 33, 599, DateTimeKind.Local).AddTicks(7443),
