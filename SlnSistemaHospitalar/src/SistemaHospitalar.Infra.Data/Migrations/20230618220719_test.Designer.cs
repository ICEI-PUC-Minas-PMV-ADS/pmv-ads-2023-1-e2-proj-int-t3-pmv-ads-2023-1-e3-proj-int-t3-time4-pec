            ...
            modelBuilder.Entity("SistemaHospitalar.Domain.Entities.Pessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "156.789.754-85",
                            CreatedOn = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8140),
                            DataNascimento = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8131),
                            Email = "ana@gmail.com",
                        ...
                        new
                        {
                            Id = 2,
                            Cpf = "456.799.466-65",
                            CreatedOn = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8141),
                            DataNascimento = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8141),
                        ...
                        new
                        {
                            Id = 3,
                            Cpf = "787.464.796-56",
                            CreatedOn = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8143),
                            DataNascimento = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8142),
                        ...
                        new
                        {
                            Id = 4,
                            Cpf = "899.799.465-78",
                            CreatedOn = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8144),
                            DataNascimento = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8144),
            ...
            modelBuilder.Entity("SistemaHospitalar.Domain.Entities.Prontuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8216),
                        ...
                        new
                        {
                            Id = 2,
                            Conduta = "Solicito EDA, PHmetria e exames laboratoriais ",
                            CreatedOn = new DateTime(2023, 6, 18, 19, 7, 18, 808, DateTimeKind.Local).AddTicks(8217),
