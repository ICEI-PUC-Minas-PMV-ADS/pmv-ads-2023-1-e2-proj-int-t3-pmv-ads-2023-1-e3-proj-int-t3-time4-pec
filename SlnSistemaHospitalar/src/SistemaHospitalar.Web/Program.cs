...
builder.Services.AddDbContext<SQLServerContext>
    (options => options.UseSqlServer("Data Source=DESKTOP-Q487H07\\SQLEXPRESS;Initial Catalog=ProntClinicDb2;Integrated Security=True;TrustServerCertificate=True"));
